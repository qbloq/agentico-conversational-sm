...
<template>
  <div class="h-full flex flex-col">
    ...
    <!-- Refresh button -->
    <div class="flex-shrink-0 p-4 safe-bottom">
      <button
        @click="escalations.fetchEscalations()"
        :disabled="escalations.loading"
        class="w-full py-3 bg-surface-800 hover:bg-surface-700 disabled:opacity-50 text-white font-medium rounded-xl transition-colors"
      >
        {{ escalations.loading ? 'Refreshing...' : 'Refresh' }}
      </button>
    </div>
  </div>
</template>
