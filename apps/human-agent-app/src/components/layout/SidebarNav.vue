...
<template>
  <div class="h-full flex flex-col">
    <!-- Header / Branding -->
    <div class="flex-shrink-0 h-16 flex items-center px-6 border-b border-surface-700">
      <div class="flex items-center gap-3">
        ...
        <span class="font-semibold text-white text-lg">Agent Hub</span>
      </div>
    </div>
    ...
    <!-- User Profile Footer -->
    <div class="flex-shrink-0 p-3 border-t border-surface-700">
      <button
